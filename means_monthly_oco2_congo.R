...
write.csv(df_all, "G:/Africa/csv/ecoregions/mask_Dans/OCO2_Congo_Monthly_Mean/OCO2_Congo_Monthly_Means_2015-2021.csv", row.names = FALSE)
write.csv(df_cs, "G:/Africa/csv/ecoregions/mask_Dans/OCO2_Congo_Monthly_Mean/OCO2_Congo_Monthly_Means_2015-2021_cs.csv", row.names = FALSE)
