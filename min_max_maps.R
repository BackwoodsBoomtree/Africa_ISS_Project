...
par(mfrow = c(5, 2), oma=c(0,0,1,0))
    ...
    plot(sif_min, main = "Minimum SIF", col = viridis(12), range = c(1,12),
    ...
    plot(sif_min, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()

    plot(sif_max, main = "Maximum SIF", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(sif_max, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(evi_min, main = "Minimum EVI", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(evi_min, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()

    plot(evi_max, main = "Maximum EVI", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(evi_max, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(precip_min, main = "Minimum Precipitation", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(precip_min, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()

    plot(precip_max, main = "Maximum Precipitation", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(precip_max, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(sm_min, main = "Minimum Volumetric Soil Water", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(sm_min, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(sm_max, main = "Maximum Volumetric Soil Water", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(sm_max, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(vpd_max, main = "Maximum VPD", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(vpd_max, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
    
    plot(vpd_min, main = "Minimum VPD", col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), mar = c(2,2,2,3))
    plot(coastlines, border = NA, col = rgb(0.90,0.90,0.90), axes = FALSE, ad = TRUE)
    plot(vpd_min, col = viridis(12), range = c(1,12),
         pax = list(side = c(1:2), tick = 0, mgp=c(3, 0.2, 0)), add = TRUE)
    axis(1, labels = FALSE, tck = 0.03)
    axis(2, labels = FALSE, tck = 0.03)
    box()
