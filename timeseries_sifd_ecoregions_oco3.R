...
csv_list <- list.files("G:/Africa/csv/ecoregions/mask_Dans/OCO3", pattern = "*.csv", full.names = TRUE)
x_labs   <- format(seq(as.Date("2019/1/1"), as.Date("2021/12/1"), "month"), "%Y-%m")
x        <- 1:36
err_col  <- "#8ab8e6"

cairo_pdf("G:/Africa/figs/timeseries_sifd_ecoregions_OCO3_2.5km_mask.pdf", width = 20, height = 15)
